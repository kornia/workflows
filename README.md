...
- `pytorch-version`: (string, default: `'2.2.1`') the pytorch version desired.
...
```yaml
  steps:
  - uses: kornia/workflows/.github/actions/env@v1.5.0
```
...
```yaml
  steps:
  - uses: kornia/workflows/.github/actions/tests@v1.5.0
```
...
```yaml
  steps:
  - uses: kornia/workflows/.github/coverage/tests@v1.5.0
```
...
- `pytorch-version`: (json list of strings, default: `'["2.2.1"]'`) a string
...
jobs:
  tests:
    uses: kornia/workflows/.github/workflows/tests@v1.5.0
    with:
...
jobs:
  coverage:
    uses: kornia/workflows/.github/workflows/coverage@v1.5.0
    with:
      python-version: "3.11"
...
jobs:
  tutorials:
    uses: kornia/workflows/.github/workflows/tutorials@v1.5.0
```
...
jobs:
  typing:
    uses: kornia/workflows/.github/workflows/mypy@v1.5.0
```
...
jobs:
  docs:
    uses: kornia/workflows/.github/workflows/docs@v1.5.0
```
