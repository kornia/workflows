...
```yaml
  steps:
  - uses: kornia/workflows/.github/actions/env@v1.9.1
```
...
```yaml
  steps:
  - uses: kornia/workflows/.github/actions/tests@v1.9.1
```
...
```yaml
  steps:
  - uses: kornia/workflows/.github/coverage/tests@v1.9.1
```
...
jobs:
  tutorials:
    uses: kornia/workflows/.github/workflows/tutorials@v1.9.1
```
...
jobs:
  typing:
    uses: kornia/workflows/.github/workflows/mypy@v1.9.1
```
...
jobs:
  docs:
    uses: kornia/workflows/.github/workflows/docs@v1.9.1
```
