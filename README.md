...
```yaml
  steps:
  - uses: kornia/workflows/.github/coverage/tests@v1.12.1
```
...
jobs:
  coverage:
    uses: kornia/workflows/.github/workflows/coverage@v1.12.1
    with:
      python-version: "3.12"
...
jobs:
  tutorials:
    uses: kornia/workflows/.github/workflows/tutorials@v1.12.1
```
...
jobs:
  typing:
    uses: kornia/workflows/.github/workflows/mypy@v1.12.1
```
...
jobs:
  docs:
    uses: kornia/workflows/.github/workflows/docs@v1.12.1
```
