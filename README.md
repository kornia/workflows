...
```yaml
  steps:
  - uses: kornia/workflows/.github/actions/env@v1.2.2
```
...
```yaml
  steps:
  - uses: kornia/workflows/.github/actions/tests@v1.2.2
```
...
```yaml
  steps:
  - uses: kornia/workflows/.github/coverage/tests@v1.2.2
```
...
jobs:
  tests:
    uses: kornia/workflows/.github/workflows/tests@v1.2.2
    with:
...
jobs:
  coverage:
    uses: kornia/workflows/.github/workflows/coverage@v1.2.2
    with:
      python-version: "3.11"
...
jobs:
  tutorials:
    uses: kornia/workflows/.github/workflows/tutorials@v1.2.2
```
...
jobs:
  typing:
    uses: kornia/workflows/.github/workflows/mypy@v1.2.2
```
...
jobs:
  docs:
    uses: kornia/workflows/.github/workflows/docs@v1.2.2
```
