...
```yaml
  steps:
  - uses: kornia/workflows/.github/actions/tests@v1.10.1
```
...
```yaml
  steps:
  - uses: kornia/workflows/.github/coverage/tests@v1.10.1
```
...
jobs:
  tests:
    uses: kornia/workflows/.github/workflows/tests@v1.10.1
    with:
...
jobs:
  coverage:
    uses: kornia/workflows/.github/workflows/coverage@v1.10.1
    with:
      python-version: "3.12"
...
jobs:
  tutorials:
    uses: kornia/workflows/.github/workflows/tutorials@v1.10.1
```
...
jobs:
  typing:
    uses: kornia/workflows/.github/workflows/mypy@v1.10.1
```
...
jobs:
  docs:
    uses: kornia/workflows/.github/workflows/docs@v1.10.1
```
